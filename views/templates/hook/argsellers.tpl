{*
 * 2026 ARGSEGURIDAD
 * Smarty template for rendering sellers grid v1.5.0
 *}
    ...
    {foreach from=$argsellers item=seller}
        <div class="argseller-col">
            <div class="argseller-card">
                ...
                {* Larger Profile Photo / Default Silhouette SVG *}
                ...
                {* Direct Action Buttons (Mobile & Tablet) *}
                ...
                <div class="argseller-hover-info">
                    ...
                    {* Reliable QR Code Generator API *}
                    ...
                    {* Added "Chatear" WhatsApp button on Desktop *}
                    ...
                    {* Fixed Mail Action Button on Desktop *}
